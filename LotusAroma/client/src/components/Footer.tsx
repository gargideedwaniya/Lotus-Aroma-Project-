      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center mb-4">
              <span className="font-serif font-bold text-2xl text-primary">Lotus Aroma</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Discover the finest luxury perfumes crafted with the purest ingredients for a truly unforgettable sensory experience.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/collections" className="text-gray-400 hover:text-primary">Collections</Link>
              </li>
              <li>
                <Link href="/bestsellers" className="text-gray-400 hover:text-primary">Best Sellers</Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-primary">About Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/faqs" className="text-gray-400 hover:text-primary">FAQs</Link>
              </li>
              <li>
                <Link href="/shipping" className="text-gray-400 hover:text-primary">Shipping & Returns</Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-400 hover:text-primary">Privacy Policy</Link>
              </li>
              <li>
                <Link href="/terms" className="text-gray-400 hover:text-primary">Terms & Conditions</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Lotus Aroma. All rights reserved.
          </p>
          <div className="flex space-x-4">
